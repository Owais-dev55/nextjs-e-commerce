  ...
  return (
    <div className="w-full min-h-screen bg-white px-4 sm:px-6 lg:px-12 py-12">
      <div className="w-full max-w-screen-lg mx-auto text-center mb-12">
        ...
        <p className="text-[#4A4A4A] mt-4 max-w-3xl mx-auto text-sm sm:text-base">
            ...
            return (
              ...
              >
                ...
                <div className="ml-4 flex-1">
                  <h3 className="font-bold text-xl sm:text-2xl lg:text-2xl text-[#1A1A1A] leading-8">
                    The quick fox jumps over
                  </h3>
                  <h6 className="font-normal text-sm sm:text-base mt-3 text-[#4A4A4A] leading-6">
