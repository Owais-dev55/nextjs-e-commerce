          ...
          <div className="gap-20 h-[742px] width-[1050px]">
            <div className="top-16 gap-7 h-[432px] w-[509]">
              ...
              <div className="w-[378px] h-40 mb-10">
                <h1 className="w-[378px] h-40 text-6xl font-bold leading-[80px]  tracking-[0.2px]">
                  Get in touch today!
                </h1>
              </div>
              ...
              <div className="w-[442px] h-[84px] pt-2">
                <h3 className="font-bold text-2xl tracking-[0.1px] leading-8  ">
                  Phone ; +451 215 215{" "}
                </h3>
                <h3 className="font-bold text-2xl pt-2 tracking-[0.1px] leading-8  ">
                  Fax : +451 215 215{" "}
                </h3>
              </div>
