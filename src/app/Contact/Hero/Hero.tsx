...
const Hero = () => {
  return (
    <div className="w-full h-[1080px] lg:h-[882px]  lg:mt-0 mt-8 ">
      <div className="container mx-auto text-[#1A1A1A] lg:w-[1440px] lg:h-[709px] text-[Montserrat]">
        <div className="px-4 lg:absolute lg:w-[1036px] lg:h-[709px] lg:pl-52 lg:pt-10 lg:pb-28 lg:gap-20">
          <div className="flex flex-col items-center lg:items-start lg:gap-20 lg:h-[742px] lg:w-[1050px]">
            <div className="lg:gap-7 lg:h-[432px] lg:w-[509px]">
              ...
              {/* Description */}
              <div className="mb-6 lg:mb-10 text-center lg:text-left">
                <p className="lg:w-[341px] md:w-[200px] sm:w-[200px] lg:mx-0 mx-auto font-normal text-lg lg:text-xl leading-8 text-[#4A4A4A] tracking-[0.2px]">
              ...
              {/* Social Media Icons */}
              <div className="flex justify-center lg:justify-start space-x-8 w-full lg:w-[442px] h-[50px] pt-4 text-[#1A1A1A]">
