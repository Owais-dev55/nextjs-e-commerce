...
const DescriptionPage = () => {
  return (
    <div className="w-full bg-[#FFFFFF]">
      ...
      <div className="hidden lg:block w-full h-[572px]">
      ...
      <div className="lg:hidden px-4 py-8">
        ...
        <div className="space-y-8">
          ...
          <div>
            <h3 className="font-bold text-2xl leading-8 tracking-wider text-[#252B42] mb-4">
              the quick fox jumps over
            </h3>
            {repeatCountPara.map((_, index) => (
              <p
                key={index}
                className="font-normal text-sm leading-5 tracking-[0.2px] text-[#737373] mb-4"
              >
                Met minim Mollie non desert Alamo est sit cliquey dolor do met sent. RELIT official consequent door ENIM RELIT Mollie. Excitation venial consequent sent nostrum met.
              </p>
            ))}
            ...
            <ul className="space-y-2">
              {repeatCount.map((_, index) => (
                <li key={index} className="flex items-center gap-2">
                  <i className="fa-solid fa-chevron-right text-[#737373] w-2 h-4"></i>
                  <h5 className="font-bold text-sm leading-5 tracking-[0.2px] text-[#737373]">
                    the quick fox jumps over the lazy dog
                  </h5>
                </li>
