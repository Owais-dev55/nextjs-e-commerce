...
const CartPage = () => {
  ...
  const applyCoupon = () => {
    if (couponCode === coupon && !couponApplied) {
      ...
      // You might want to show a message that the coupon is already applied
    } else {
      // You might want to show an error message for invalid coupon
    }
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          <div className="lg:w-2/3 w-full bg-white rounded-lg shadow-lg p-6">
            {cartItems.length === 0 ? (
              <p className="text-center text-gray-500 text-xl font-semibold">Your cart is empty.</p>
            ) : (
              cartItems.map((item) => (
                <div
                  key={item._id}
          ...
          <div className="lg:w-1/3 w-full mt-8 lg:mt-0">
            <div className="bg-white p-6 lg:p-8 rounded-lg shadow-lg sticky top-8">
              ...
              <div className="space-y-4 mb-6">
                ...
                {couponApplied && (
                  <div className="flex justify-between items-center">
                    <span className="text-[#737373] text-sm lg:text-base">Discount (10%)</span>
                    <span className="text-[#2DC071] font-semibold text-base lg:text-lg">-${discount.toFixed(2)}</span>
                  </div>
                )}
              </div>
              ...
              <div className="flex items-center space-x-2 mb-6">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-md text-white font-semibold ${
                    couponApplied ? "bg-gray-400 cursor-not-allowed" : "bg-[#2DC071] hover:bg-[#28a864]"
