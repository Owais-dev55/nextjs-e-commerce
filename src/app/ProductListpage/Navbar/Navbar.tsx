...
const Navbar = () => {
  return (
    ...
    <div className="hidden lg:flex justify-between items-center bg-[#23856D] text-[#FFFFFF] font-bold text-sm px-6 py-2">
      <div className="flex items-center space-x-5 w-[415px] gap-2 h-11 pl-14">
        <h6 className="font-normal">
          <i className="fas fa-phone text-[12px] "></i> (225) 555-0118
        </h6>
        <h6 className="font-normal">
          <i className="fas fa-envelope text-[12px] "></i> michelle.rivera@example.com
        </h6>
      </div>
