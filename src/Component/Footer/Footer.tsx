...
const Footer = ({ backgroundColor }: bgcolor) => {
  const sections = [
    ...
    {
      title: "Features",
      links: ["Business Marketing", "User Analytic", "Live chats ", "Unlimited Support"],
    },
    {
      title: "Resources",
      ...
      <div className="w-full">
        ...
        <div className="w-full py-6 sm:py-8 px-4 sm:px-6 lg:px-8" style={{ backgroundColor }}>
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center">
            <h3 className="text-[#1A1A1A] font-bold text-xl sm:text-2xl leading-8 mb-4 sm:mb-0">VogueAura</h3>
        ...
        <div className="max-w-7xl mx-auto py-6 sm:py-8 px-4 sm:px-6 lg:px-8">
              ...
              <div key={index} className="mb-6 md:mb-0">
                ...
                <ul className="space-y-2">
                  {section.links.map((link, i) => (
                    <li key={i} className="text-sm font-medium leading-6 tracking-[0.2px] text-[#4A4A4A]">
                      {link}
                    </li>
                  ))}
                </ul>
          ...
          {/* Subscription section - separated from the grid for better tablet layout */}
          <div className="mt-8 md:mt-10">
            ...
            <div className="space-y-4">
              ...
              <p className="text-[#4A4A4A] text-xs leading-6">Lorem ipsum dolor sit Amet</p>
            </div>
          </div>
        </div>
