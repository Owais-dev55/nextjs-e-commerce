        ...
        <div className='absolute w-[1036px] h-[709] pl-52 pt-28 pb-28 gap-20'>
            <div className='gap-7 h-[599px] width-[1049px]'>
                <div className='top-16 gap-7 h-[432px] w-[509]'>
                    ...
                    <h1 className='w-[509px] h-40 text-6xl font-bold leading-[80px]  tracking-[0.2px]'>Vita Classic Product</h1>
                    </div>
                    ...
                    <h3 className='w-20 h-8 font-bold text-2xl leading-8 tracking-[0.1px] mt-2 flex justify-center items-center'>$16.48</h3>
                    <div className="w-[295px] h-[52px]">
                    <button className="w-full h-full rounded-md font-bold uppercase text-[
